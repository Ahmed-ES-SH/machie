...
const FirstSectionCellPhones = () => {
  return (
    <>
      <section className="f-banner h-[100px] max-md:h-fit m-auto dual-center max-md:flex-col max-md:gap-y-4 max-md:items-start bg-normal ">
      ...
      <section className="s-banner grid grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1  gap-4 mt-4 ">
...
export default FirstSectionCellPhones;
